...
def get_ner_fmeasure(golden_lists, predict_lists, label_type="BMES"):
    accuracy = accuracy_score(golden_lists,predict_lists)
    precision = precision_score(golden_lists,predict_lists)
    recall = recall_score(golden_lists,predict_lists)
    f_measure  = f1_score(golden_lists,predict_lists)
    return accuracy, precision, recall, f_measure

def get_chunk_fmeasure(golden_lists, predict_lists, label_type="BMES"):
    sent_num = len(golden_lists)
    golden_full = []
    predict_full = []
    right_full = []
...
def get_pos_fmeasure(golden_lists,predict_lists):
    accuracy = accuracy_score(golden_lists,predict_lists)
    precision = precision_score(golden_lists,predict_lists)
    recall = recall_score(golden_lists,predict_lists)
    f_measure  = f1_score(golden_lists,predict_lists)
...
# def get_chunk_fmeasure(golden_lists,predict_lists):
#     accuracy = accuracy_score(golden_lists,predict_lists)
#     precision = precision_score(golden_lists,predict_lists)
#     recall = recall_score(golden_lists,predict_lists)
#     f_measure  = f1_score(golden_lists,predict_lists)
